...
Mobil webbapp för femkampen med de fasta lagen Codex, Jenkins och AWS. Tipspromenaden genomförs analogt för att undvika telefonfusk. Varje lag kan ha en egen telefon; poängen sparas lokalt direkt och synkas automatiskt till Supabase när konfigurationen är ifylld.
